...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AlexHmelevskiAG/AHNetwork'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AlexHmelevskiAG' => 'alex.hmelevski@gmail.com' }
  s.source           = { :git => 'https://github.com/AlexHmelevskiAG/AHNetwork.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'AHNetwork' => ['AHNetwork/Assets/*.png']
  # }
